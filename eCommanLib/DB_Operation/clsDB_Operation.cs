...
public class clsDB_Operation 
{
    ...
    public clsDB_Operation()
    {
        try
        {
            ...
            mdbCommand.CommandTimeout = 172800;
            objConnection = new SqlConnection(@"Data Source=DESKTOP-L3I2L0U\SQLEXPRESS;Initial Catalog=project;Integrated Security=True");//"(SqlConnection)Session["HRSqlConnection"];
            OnStartConnection();
